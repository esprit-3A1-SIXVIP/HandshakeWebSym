...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\RefugeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity')]);
...
$a->setEntityNamespaces(['RefugeBundle' => 'RefugeBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity']);
