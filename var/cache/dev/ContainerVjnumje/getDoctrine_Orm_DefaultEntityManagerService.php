...
$c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->getAnnotationReaderService()) && false ?: '_'}, [0 => ($this->targetDirs[3].'\\src\\RefugeBundle\\Entity'), 1 => ($this->targetDirs[3].'\\src\\UserBundle\\Entity'), 2 => ($this->targetDirs[3].'\\src\\EvenementBundle\\Entity'), 3 => ($this->targetDirs[3].'\\src\\BlogBundle\\Entity'), 4 => ($this->targetDirs[3].'\\src\\AideBundle\\Entity'), 5 => ($this->targetDirs[3].'\\src\\DonBundle\\Entity')]);

$b->addDriver($c, 'RefugeBundle\\Entity');
$b->addDriver($c, 'UserBundle\\Entity');
$b->addDriver($c, 'EvenementBundle\\Entity');
$b->addDriver($c, 'BlogBundle\\Entity');
$b->addDriver($c, 'AideBundle\\Entity');
$b->addDriver($c, 'DonBundle\\Entity');
...
$a->setEntityNamespaces(['RefugeBundle' => 'RefugeBundle\\Entity', 'UserBundle' => 'UserBundle\\Entity', 'EvenementBundle' => 'EvenementBundle\\Entity', 'BlogBundle' => 'BlogBundle\\Entity', 'AideBundle' => 'AideBundle\\Entity', 'DonBundle' => 'DonBundle\\Entity']);
